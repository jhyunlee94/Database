...
2. RDB(Relational Data Base) : 관계형 데이터 베이스
    ...
    - Relational(관계형) : 분산되어 있는 테이블들간의 관계
...
8. 서브쿼리
    ...
    - 조회하는 컬럼이 될 수도 있고, FROM 구문에 테이블 대신 사용
      WHERE 조건으로도 사용 가능
    - 서브쿼리는 항상 괄호로 묶어야됨
...
9. 집합연산자
    ...
    - UNION ALL : 조회된 결과 합으로 중복된 데이터 포함
